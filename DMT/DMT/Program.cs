...
namespace DMT
{
    ...
    //项目原始及最新版本的在SourceForge用svn进行管理 https://sourceforge.net/projects/dualmonitortool/
    //<image url="$(ProjectDir)\DocumentImages\DualMonitorTools_SourceForge.png"/>
    /// <summary>
    /// Top level program
    /// </summary>
    internal static class Program
    {
        ...
        private static bool ActivateExistingGui()
        {
        ...
        private static void ConsoleMain(ProgramOptions programOptions)
        {
        ...
        private static void GuiMain(ProgramOptions programOptions)
        {
